...
namespace LiberB1Sync.Class
{
    class LiberRabbit
    {
        ...
        public bool WriteJson(string json)
        {
            ...
            String queueName = "invoice.batch.imported";
            bool success = true;
            try
            {
                //success = WriteMessageOnQueue(json, queueName, conn);
                //VerifyBatch("b27b7cc7-ba8f-49a6-88cf-f0afa14afe93");
        ...
        //public bool VerifyBatch(String batch)
        //{
        ...
        public bool WriteMessageOnQueue(string message, string queueName, IConnection connection)
        {
            try
            {
                ...
                VerifySends("55fa2bd1-5f03-4153-8102-addaa44d6c3a");
        ...
        private void VerifySends(string message)
        {
            String queuename = "invoice.batch.imported";
            String json;
